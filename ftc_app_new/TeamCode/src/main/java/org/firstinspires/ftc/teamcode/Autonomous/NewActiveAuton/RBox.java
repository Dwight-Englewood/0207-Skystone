 ...
 */
    ...
    public void loop() {
        switch (robot.command) {
            ...
            case 2:
                robot.runToTarget(Movement.RIGHTSTRAFE, 64);
                break;
            ...
            case 14:
                robot.runToTarget(Movement.RIGHTSTRAFE, 140);
                break;
            ...
            case 107:
                robot.runToTarget(Movement.RIGHTSTRAFE, 160);
                break;
            ...
            case 1007:
                robot.runToTarget(Movement.RIGHTSTRAFE, 180);
                break;
